				...
				<OnboardingContainer>
					...
					<Flex direction="column">
						...
						<Text fontSize="lg" color="petcode.neutral.600">
							If you’d like to set up reminders for your pet’s health needs, you
							can customize reminders here!
						</Text>
					</Flex>
					<Text fontSize="lg" fontWeight="semibold" color="petcode.neutral.600">
						Reminder #{index + 1}
					</Text>
					<Form>
						<Stack spacing={6}>
